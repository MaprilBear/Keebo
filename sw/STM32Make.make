...
# ASM sources
ASM_SOURCES =  \
STM32CubeIDE/Application/Startup/startup_stm32l552zetxq.s
...
GCC_PATH="c:/Users/plays/AppData/Roaming/Code/User/globalStorage/bmd.stm32-for-vscode/@xpack-dev-tools/arm-none-eabi-gcc/13.2.1-1.1.1/.content/bin
ifdef GCC_PATH
...
#######################################
# link script
LDSCRIPT = STM32CubeIDE/STM32L552ZETXQ_FLASH.ld
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/PLAYS/APPDATA/ROAMING/CODE/USER/GLOBALSTORAGE/BMD.STM32-FOR-VSCODE/@XPACK-DEV-TOOLS/OPENOCD/0.12.0-3.1/.CONTENT/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/PLAYS/APPDATA/ROAMING/CODE/USER/GLOBALSTORAGE/BMD.STM32-FOR-VSCODE/@XPACK-DEV-TOOLS/OPENOCD/0.12.0-3.1/.CONTENT/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32l5x mass_erase 0; exit"
