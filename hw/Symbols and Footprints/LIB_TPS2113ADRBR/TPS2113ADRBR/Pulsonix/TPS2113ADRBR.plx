...
//3983602/1211395/2.50/9/3/Integrated Circuit
...
(library Library_1
	...
	(padStyleDef "r245_170"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 1.7) (shapeHeight 2.45))
		(padShape (layerNumRef 16) (padShapeType Ellipse)  (shapeWidth 0) (shapeHeight 0))
	)
	(textStyleDef "Normal"
		(font
	...
	(patternDef "SON65P300X300X100-9N" (originalName "SON65P300X300X100-9N")
		(multiLayer
			...
			(pad (padNum 9) (padStyleRef r245_170) (pt 0, 0) (rotation 0))
		)
	...
	(symbolDef "TPS2113ADRBR" (originalName "TPS2113ADRBR")
	...
	(compDef "TPS2113ADRBR" (originalName "TPS2113ADRBR") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "VSNS") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "IN1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "GND_1") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS2113ADRBR"))
		...
		(attr "Mouser Part Number" "595-TPS2113ADRBR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS2113ADRBR?qs=g%2FrhRe7LVpRsXhRevikZ7Q%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPS2113ADRBR")
		(attr "Description" "Power Switch ICs - Power Distribution Autoswitching Pwr Mux")
		(attr "<Hyperlink>" "https://www.ti.com/lit/gpn/TPS2113A")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "TPS2113ADRBR.stp")
