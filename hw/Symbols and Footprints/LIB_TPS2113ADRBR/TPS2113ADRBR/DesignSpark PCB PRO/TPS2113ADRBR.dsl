...
(library Library_1
	...
	(compDef "TPS2113ADRBR" (originalName "TPS2113ADRBR") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "VSNS") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "8" (pinName "IN1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "5" (pinName "GND_1") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.ti.com/lit/gpn/TPS2113A")
		(attr "Height" "1 mm")
	)
