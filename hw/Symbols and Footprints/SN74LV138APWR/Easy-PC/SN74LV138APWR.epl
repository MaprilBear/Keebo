...
(library Library_1
	...
	(compDef "SN74LV138APWR" (originalName "SN74LV138APWR") (compHeader (numPins 16) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "__G2A") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "__G2B") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "G1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/sn74lv138a")
		(attr "Height" "1.2 mm")
	)
